...
export const Wheel: React.FC<WheelProps> = ({ onSpinComplete, isSpinning }) => {
  ...
  return (
    <div className="relative w-64 h-64 mx-auto">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-12 h-12 bg-black border-4 border-white rounded-full flex items-center justify-center z-20">
